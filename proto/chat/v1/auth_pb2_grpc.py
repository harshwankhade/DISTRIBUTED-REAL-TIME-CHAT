...
from proto.chat.v1 import auth_pb2 as proto_dot_chat_dot_v1_dot_auth__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in proto/chat/v1/auth_pb2_grpc.py depends on'
...
def add_AuthServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'distributed_chat.v1.AuthService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('distributed_chat.v1.AuthService', rpc_method_handlers)
...
class AuthService:
    ...
    def Login(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/distributed_chat.v1.AuthService/Login',
            proto_dot_chat_dot_v1_dot_auth__pb2.LoginRequest.SerializeToString,
